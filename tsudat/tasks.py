...
def run_tsudat_simulation(user, scenario_id):
    ...
    for result in output_json['results_max']:
        ...
        # Apply 'default' permissions for the new layers

        new_layer = save(base, tif_file_path, user, overwrite = False, title=layer_title, abstract=layer_abstract, keywords = keywords) 
    ...
    # Apply 'default' permissions to the new map
