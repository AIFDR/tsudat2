...
class ScenarioAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'project', 'model_setup', 'anuga_status', 'anuga_instance', 'tsudat_start_timestamp', 'anuga_start_timestamp', 'anuga_end_timestamp','tsudat_end_timestamp')
...
admin.site.register(ScenarioLayer, admin.ModelAdmin)
